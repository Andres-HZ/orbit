# plan-recommendation-engine Specification

## Purpose
Generate structured personalized activity recommendations from current context and stored user preferences.
...
#### Scenario: Selected language used
- **WHEN** a plan is generated by the AI adapter or fallback generator
- **THEN** user-facing generated titles, summaries, activity text, and explanations MUST use the submitted locale
